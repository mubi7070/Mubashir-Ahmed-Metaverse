...
const make_album = (artist_name,title,NoOfTrack=null) => {
    return {
        Artist: artist_name,
        Album_Title: title,
        TrackNo: NoOfTrack
...
console.log(make_album("Ali","Sherwani"));
console.log(make_album("Sajal","Qalam"));
console.log(make_album("Ed Sheren","Love"));

console.log(make_album("Ed Sheren","Love", 2051));